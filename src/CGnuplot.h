...
// 
 ...
 //---------------------------------------------------------------------------------Construtores
  ...
  /// @brief Salva sessao do gnuplot para um arquivo postscript, informe o nome do arquivo sem extensao. 
  ...
  /// @brief Salva sessao do gnuplot para um arquivo png, nome do arquivo sem extensao 
  /// Depois retorna para modo terminal
  ...
  /// @brief Salva sessao do gnuplot para um arquivo jpg, nome do arquivo sem extensao 
  /// Depois retorna para modo terminal
  ...
  /// @brief Salva sessao do gnuplot para um arquivo filename, usando o terminal_type e algum flag adicional
  /// Ex: 
  /// grafico.SaveTo("pressao_X_temperatura","png", "enhanced size 1280,960");
  /// Para melhor uso dos flags adicionais consulte o manual do gnuplot (help term)
  Gnuplot& SaveTo(const std::string &filename,const std::string &terminal_type, std::string flags="");
