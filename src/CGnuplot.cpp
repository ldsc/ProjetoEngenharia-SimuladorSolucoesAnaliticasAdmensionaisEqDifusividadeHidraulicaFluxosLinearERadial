...
#endif
        true;//throw GnuplotException("Problem closing communication to gnuplot");
}
...
{
//     this->cmd("set terminal postscript color");         // Tipo de terminal (tipo de arquivo)
// 
...
//----------------------------------------------------------------------------------
// saves a gnuplot session to a png file and return do on screen terminal
Gnuplot& Gnuplot::savetopng(const std::string &filename)
{   
//                                                         // Muda o terminal
//     this->cmd("set term png enhanced size 1280,960");   // Tipo de terminal (tipo de arquivo)
// 
//     std::ostringstream cmdstr;                          // Muda o nome do arquivo
...
//----------------------------------------------------------------------------------
// saves a gnuplot session to a jpeg file and return do on screen terminal
Gnuplot& Gnuplot::savetojpeg(const std::string &filename)
{   
                                                        // Muda o terminal
//     this->cmd("set term jpeg enhanced size 1280,960");   // Tipo de terminal (tipo de arquivo)
// 
//     std::ostringstream cmdstr;                          // Muda o nome do arquivo
...
// @flags: aditional information specitif to terminal type
// Ex:
// grafico.SaveTo("pressao_X_temperatura","png", "enhanced size 1280,960");
// grafico.TerminalType("png").SaveFile(pressao_X_temperatura); pense nisso?
Gnuplot& Gnuplot::SaveTo(const std::string &filename,const std::string &terminal_type, std::string flags)
{                                                       // Muda o terminal
    this->cmd("set term " + terminal_type + " " + flags);    // Tipo de terminal (tipo de arquivo) e flags adicionais
    std::ostringstream cmdstr;                          // Muda o nome do arquivo
